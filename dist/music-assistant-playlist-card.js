...
`;var _e={now_playing:"Now Playing",playlists:"Playlists",search:"Search",speakers:"Speakers"},ye={loading:"Loading...",error:"An error occurred",no_playlists:"No playlists found",play:"Play",select_speaker:"Select Speaker",no_speaker_selected:"No speaker selected",nothing_playing:"Nothing is currently playing",search:"Search",search_playlists:"Search playlists...",search_placeholder:"Search for songs, albums, artists...",search_hint:"Search for music to play",browse_library:"Browse your music library",end_of_list:"End of list",tracks:"Tracks",albums:"Albums",artists:"Artists",favorites:"Favorites",add_favorite:"Add to favorites",remove_favorite:"Remove from favorites",all:"All",sort:"Sort",sort_name:"Name (A-Z)",sort_name_desc:"Name (Z-A)",sort_tracks:"Track count",sort_recent:"Recently added",view_grid:"Grid view",view_list:"List view",no_results:"No results found",play_all:"Play All",back:"Back",no_tracks:"No tracks found"},fe={title:"Card Title",config_entry_id:"Music Assistant Instance",speakers:"Speakers",limit:"Number of Playlists",card_height:"Card Height (px)",card_height_helper:"Smaller height = smaller artwork",columns:"Columns",columns_auto:"Auto",favorites_only:"Favorites Only",language:"Language",language_auto:"Auto (from Home Assistant)"},be={missing_config:"Missing configuration. Please configure the card.",missing_speakers:"No speakers configured. Please add speakers in card settings.",load_failed:"Failed to load playlists. Please check your Music Assistant configuration.",play_failed:"Failed to play playlist"},ve={tabs:_e,common:ye,config:fe,error:be},ke={now_playing:"מתנגן עכשיו",playlists:"פלייליסטים",search:"חיפוש",speakers:"רמקולים"},xe={loading:"טוען...",error:"אירעה שגיאה",no_playlists:"לא נמצאו פלייליסטים",play:"הפעל",select_speaker:"בחר רמקול",no_speaker_selected:"לא נבחר רמקול",nothing_playing:"אין כרגע מוזיקה מתנגנת",search:"חיפוש",search_playlists:"חפש פלייליסטים...",search_placeholder:"חפש שירים, אלבומים, אמנים...",search_hint:"חפש מוזיקה להשמעה",browse_library:"דפדף בספריית המוזיקה שלך",end_of_list:"סוף הרשימה",tracks:"שירים",albums:"אלבומים",artists:"אמנים",favorites:"מועדפים",add_favorite:"הוסף למועדפים",remove_favorite:"הסר מהמועדפים",all:"הכל",sort:"מיון",sort_name:"שם (א-ת)",sort_name_desc:"שם (ת-א)",sort_tracks:"מספר שירים",sort_recent:"נוספו לאחרונה",view_grid:"תצוגת רשת",view_list:"תצוגת רשימה",no_results:"לא נמצאו תוצאות",play_all:"נגן הכל",back:"חזור",no_tracks:"לא נמצאו שירים"},we={title:"כותרת הכרטיס",config_entry_id:"מופע Music Assistant",speakers:"רמקולים",limit:"מספר פלייליסטים",card_height:"גובה הכרטיס (פיקסלים)",card_height_helper:"גובה קטן יותר = תמונה קטנה יותר",columns:"עמודות",columns_auto:"אוטומטי",favorites_only:"מועדפים בלבד",language:"שפה",language_auto:"אוטומטי (מ-Home Assistant)"},$e={missing_config:"חסרה הגדרה. אנא הגדר את הכרטיס.",missing_speakers:"לא הוגדרו רמקולים. אנא הוסף רמקולים בהגדרות הכרטיס.",load_failed:"נכשל בטעינת פלייליסטים. אנא בדוק את הגדרות Music Assistant.",play_failed:"נכשל בהפעלת הפלייליסט"},Se={tabs:ke,common:xe,config:we,error:$e},Ae={now_playing:"قيد التشغيل",playlists:"قوائم التشغيل",search:"بحث",speakers:"مكبرات الصوت"},ze={loading:"جاري التحميل...",error:"حدث خطأ",no_playlists:"لم يتم العثور على قوائم تشغيل",play:"تشغيل",select_speaker:"اختر مكبر الصوت",no_speaker_selected:"لم يتم اختيار مكبر صوت",nothing_playing:"لا يوجد شيء قيد التشغيل حالياً",search:"بحث",search_playlists:"البحث في قوائم التشغيل...",search_placeholder:"البحث عن أغاني، ألبومات، فنانين...",search_hint:"ابحث عن موسيقى لتشغيلها",browse_library:"تصفح مكتبة الموسيقى الخاصة بك",end_of_list:"نهاية القائمة",tracks:"أغاني",albums:"ألبومات",artists:"فنانين",favorites:"المفضلة",add_favorite:"إضافة إلى المفضلة",remove_favorite:"إزالة من المفضلة",all:"الكل",sort:"ترتيب",sort_name:"الاسم (أ-ي)",sort_name_desc:"الاسم (ي-أ)",sort_tracks:"عدد المقاطع",sort_recent:"المضافة حديثاً",view_grid:"عرض شبكي",view_list:"عرض قائمة",no_results:"لا توجد نتائج",play_all:"تشغيل الكل",back:"رجوع",no_tracks:"لم يتم العثور على أغاني"},Pe={title:"عنوان البطاقة",config_entry_id:"مثيل Music Assistant",speakers:"مكبرات الصوت",limit:"عدد قوائم التشغيل",card_height:"ارتفاع البطاقة (بكسل)",card_height_helper:"ارتفاع أقل = صورة أصغر",columns:"الأعمدة",columns_auto:"تلقائي",favorites_only:"المفضلة فقط",language:"اللغة",language_auto:"تلقائي (من Home Assistant)"},Me={missing_config:"الإعدادات مفقودة. يرجى تهيئة البطاقة.",missing_speakers:"لم يتم تهيئة مكبرات الصوت. يرجى إضافة مكبرات صوت.",load_failed:"فشل تحميل قوائم التشغيل. يرجى التحقق من إعدادات Music Assistant.",play_failed:"فشل تشغيل قائمة التشغيل"},Te={tabs:Ae,common:ze,config:Pe,error:Me},Ce={now_playing:"Läuft gerade",playlists:"Wiedergabelisten",search:"Suche",speakers:"Lautsprecher"},Ne={loading:"Laden...",error:"Ein Fehler ist aufgetreten",no_playlists:"Keine Wiedergabelisten gefunden",play:"Abspielen",select_speaker:"Lautsprecher auswählen",no_speaker_selected:"Kein Lautsprecher ausgewählt",nothing_playing:"Es wird derzeit nichts abgespielt",search:"Suchen",search_playlists:"Wiedergabelisten suchen...",search_placeholder:"Lieder, Alben, Künstler suchen...",search_hint:"Nach Musik zum Abspielen suchen",browse_library:"Durchstöbere deine Musikbibliothek",end_of_list:"Ende der Liste",tracks:"Titel",albums:"Alben",artists:"Künstler",favorites:"Favoriten",add_favorite:"Zu Favoriten hinzufügen",remove_favorite:"Aus Favoriten entfernen",all:"Alle",sort:"Sortieren",sort_name:"Name (A-Z)",sort_name_desc:"Name (Z-A)",sort_tracks:"Anzahl Titel",sort_recent:"Kürzlich hinzugefügt",view_grid:"Rasteransicht",view_list:"Listenansicht",no_results:"Keine Ergebnisse gefunden",play_all:"Alle abspielen",back:"Zurück",no_tracks:"Keine Titel gefunden"},Ee={title:"Kartentitel",config_entry_id:"Music Assistant Instanz",speakers:"Lautsprecher",limit:"Anzahl der Wiedergabelisten",card_height:"Kartenhöhe (px)",card_height_helper:"Kleinere Höhe = kleineres Artwork",columns:"Spalten",columns_auto:"Automatisch",favorites_only:"Nur Favoriten",language:"Sprache",language_auto:"Automatisch (von Home Assistant)"},je={missing_config:"Konfiguration fehlt. Bitte konfigurieren Sie die Karte.",missing_speakers:"Keine Lautsprecher konfiguriert. Bitte fügen Sie Lautsprecher hinzu.",load_failed:"Wiedergabelisten konnten nicht geladen werden. Überprüfen Sie die Music Assistant Konfiguration.",play_failed:"Wiedergabeliste konnte nicht abgespielt werden"},Oe={tabs:Ce,common:Ne,config:Ee,error:je},Re={now_playing:"En cours",playlists:"Playlists",search:"Recherche",speakers:"Enceintes"},Le={loading:"Chargement...",error:"Une erreur s'est produite",no_playlists:"Aucune playlist trouvée",play:"Lecture",select_speaker:"Sélectionner un haut-parleur",no_speaker_selected:"Aucun haut-parleur sélectionné",nothing_playing:"Rien n'est en cours de lecture",search:"Rechercher",search_playlists:"Rechercher des playlists...",search_placeholder:"Rechercher chansons, albums, artistes...",search_hint:"Rechercher de la musique à jouer",browse_library:"Parcourir votre bibliothèque musicale",end_of_list:"Fin de la liste",tracks:"Pistes",albums:"Albums",artists:"Artistes",favorites:"Favoris",add_favorite:"Ajouter aux favoris",remove_favorite:"Retirer des favoris",all:"Tout",sort:"Trier",sort_name:"Nom (A-Z)",sort_name_desc:"Nom (Z-A)",sort_tracks:"Nombre de pistes",sort_recent:"Ajoutés récemment",view_grid:"Vue grille",view_list:"Vue liste",no_results:"Aucun résultat trouvé",play_all:"Tout lire",back:"Retour",no_tracks:"Aucune piste trouvée"},Ie={title:"Titre de la carte",config_entry_id:"Instance Music Assistant",speakers:"Haut-parleurs",limit:"Nombre de playlists",card_height:"Hauteur de la carte (px)",card_height_helper:"Hauteur réduite = image réduite",columns:"Colonnes",columns_auto:"Automatique",favorites_only:"Favoris uniquement",language:"Langue",language_auto:"Automatique (depuis Home Assistant)"},He={missing_config:"Configuration manquante. Veuillez configurer la carte.",missing_speakers:"Aucun haut-parleur configuré. Veuillez ajouter des haut-parleurs.",load_failed:"Échec du chargement des playlists. Vérifiez la configuration de Music Assistant.",play_failed:"Échec de la lecture de la playlist"},Fe={tabs:Re,common:Le,config:Ie,error:He},Ue={now_playing:"Reproduciendo",playlists:"Listas",search:"Buscar",speakers:"Altavoces"},De={loading:"Cargando...",error:"Se produjo un error",no_playlists:"No se encontraron listas de reproducción",play:"Reproducir",select_speaker:"Seleccionar altavoz",no_speaker_selected:"Ningún altavoz seleccionado",nothing_playing:"No se está reproduciendo nada",search:"Buscar",search_playlists:"Buscar listas...",search_placeholder:"Buscar canciones, álbumes, artistas...",search_hint:"Buscar música para reproducir",browse_library:"Explorar tu biblioteca de música",end_of_list:"Fin de la lista",tracks:"Pistas",albums:"Álbumes",artists:"Artistas",favorites:"Favoritos",add_favorite:"Añadir a favoritos",remove_favorite:"Eliminar de favoritos",all:"Todo",sort:"Ordenar",sort_name:"Nombre (A-Z)",sort_name_desc:"Nombre (Z-A)",sort_tracks:"Número de pistas",sort_recent:"Añadidos recientemente",view_grid:"Vista cuadrícula",view_list:"Vista lista",no_results:"No se encontraron resultados",play_all:"Reproducir todo",back:"Volver",no_tracks:"No se encontraron pistas"},Ve={title:"Título de la tarjeta",config_entry_id:"Instancia de Music Assistant",speakers:"Altavoces",limit:"Número de listas de reproducción",card_height:"Altura de la tarjeta (px)",card_height_helper:"Menor altura = imagen más pequeña",columns:"Columnas",columns_auto:"Automático",favorites_only:"Solo favoritos",language:"Idioma",language_auto:"Automático (desde Home Assistant)"},Ke={missing_config:"Falta la configuración. Por favor, configure la tarjeta.",missing_speakers:"No hay altavoces configurados. Por favor, agregue altavoces.",load_failed:"Error al cargar las listas de reproducción. Verifique la configuración de Music Assistant.",play_failed:"Error al reproducir la lista de reproducción"},We={tabs:Ue,common:De,config:Ve,error:Ke},Be={now_playing:"In riproduzione",playlists:"Playlist",search:"Cerca",speakers:"Altoparlanti"},Ze={loading:"Caricamento...",error:"Si è verificato un errore",no_playlists:"Nessuna playlist trovata",play:"Riproduci",select_speaker:"Seleziona altoparlante",no_speaker_selected:"Nessun altoparlante selezionato",nothing_playing:"Nessuna riproduzione in corso",search:"Cerca",search_playlists:"Cerca playlist...",search_placeholder:"Cerca brani, album, artisti...",search_hint:"Cerca musica da riprodurre",browse_library:"Sfoglia la tua libreria musicale",end_of_list:"Fine della lista",tracks:"Brani",albums:"Album",artists:"Artisti",favorites:"Preferiti",add_favorite:"Aggiungi ai preferiti",remove_favorite:"Rimuovi dai preferiti",all:"Tutti",sort:"Ordina",sort_name:"Nome (A-Z)",sort_name_desc:"Nome (Z-A)",sort_tracks:"Numero di tracce",sort_recent:"Aggiunti di recente",view_grid:"Vista griglia",view_list:"Vista elenco",no_results:"Nessun risultato trovato",play_all:"Riproduci tutto",back:"Indietro",no_tracks:"Nessun brano trovato"},qe={title:"Titolo scheda",config_entry_id:"Istanza Music Assistant",speakers:"Altoparlanti",limit:"Numero di playlist",card_height:"Altezza scheda (px)",card_height_helper:"Altezza minore = immagine più piccola",columns:"Colonne",columns_auto:"Auto",favorites_only:"Solo preferiti",language:"Lingua",language_auto:"Auto (da Home Assistant)"},Qe={missing_config:"Configurazione mancante. Configura la scheda.",missing_speakers:"Nessun altoparlante configurato. Aggiungi altoparlanti.",load_failed:"Impossibile caricare le playlist. Controlla la configurazione di Music Assistant.",play_failed:"Impossibile riprodurre la playlist"},Ge={tabs:Be,common:Ze,config:qe,error:Qe},Je={now_playing:"Tocando agora",playlists:"Playlists",search:"Pesquisar",speakers:"Alto-falantes"},Ye={loading:"Carregando...",error:"Ocorreu um erro",no_playlists:"Nenhuma playlist encontrada",play:"Reproduzir",select_speaker:"Selecionar alto-falante",no_speaker_selected:"Nenhum alto-falante selecionado",nothing_playing:"Nada está tocando no momento",search:"Pesquisar",search_playlists:"Pesquisar playlists...",search_placeholder:"Pesquisar músicas, álbuns, artistas...",search_hint:"Pesquisar música para tocar",browse_library:"Navegar pela sua biblioteca de música",end_of_list:"Fim da lista",tracks:"Faixas",albums:"Álbuns",artists:"Artistas",favorites:"Favoritos",add_favorite:"Adicionar aos favoritos",remove_favorite:"Remover dos favoritos",all:"Todos",sort:"Ordenar",sort_name:"Nome (A-Z)",sort_name_desc:"Nome (Z-A)",sort_tracks:"Número de faixas",sort_recent:"Adicionados recentemente",view_grid:"Visualização em grade",view_list:"Visualização em lista",no_results:"Nenhum resultado encontrado",play_all:"Reproduzir tudo",back:"Voltar",no_tracks:"Nenhuma faixa encontrada"},Xe={title:"Título do cartão",config_entry_id:"Instância do Music Assistant",speakers:"Alto-falantes",limit:"Número de playlists",card_height:"Altura do cartão (px)",card_height_helper:"Altura menor = imagem menor",columns:"Colunas",columns_auto:"Auto",favorites_only:"Apenas favoritos",language:"Idioma",language_auto:"Auto (do Home Assistant)"},et={missing_config:"Configuração ausente. Configure o cartão.",missing_speakers:"Nenhum alto-falante configurado. Adicione alto-falantes.",load_failed:"Falha ao carregar playlists. Verifique a configuração do Music Assistant.",play_failed:"Falha ao reproduzir a playlist"},tt={tabs:Je,common:Ye,config:Xe,error:et},it={now_playing:"Nu speelt",playlists:"Afspeellijsten",search:"Zoeken",speakers:"Luidsprekers"},at={loading:"Laden...",error:"Er is een fout opgetreden",no_playlists:"Geen afspeellijsten gevonden",play:"Afspelen",select_speaker:"Speaker selecteren",no_speaker_selected:"Geen speaker geselecteerd",nothing_playing:"Er wordt momenteel niets afgespeeld",search:"Zoeken",search_playlists:"Afspeellijsten zoeken...",search_placeholder:"Zoek nummers, albums, artiesten...",search_hint:"Zoek muziek om af te spelen",browse_library:"Blader door je muziekbibliotheek",end_of_list:"Einde van de lijst",tracks:"Nummers",albums:"Albums",artists:"Artiesten",favorites:"Favorieten",add_favorite:"Toevoegen aan favorieten",remove_favorite:"Verwijderen uit favorieten",all:"Alles",sort:"Sorteren",sort_name:"Naam (A-Z)",sort_name_desc:"Naam (Z-A)",sort_tracks:"Aantal nummers",sort_recent:"Recent toegevoegd",view_grid:"Rasterweergave",view_list:"Lijstweergave",no_results:"Geen resultaten gevonden",play_all:"Alles afspelen",back:"Terug",no_tracks:"Geen nummers gevonden"},st={title:"Kaarttitel",config_entry_id:"Music Assistant instantie",speakers:"Speakers",limit:"Aantal afspeellijsten",card_height:"Kaarthoogte (px)",card_height_helper:"Kleinere hoogte = kleinere afbeelding",columns:"Kolommen",columns_auto:"Automatisch",favorites_only:"Alleen favorieten",language:"Taal",language_auto:"Automatisch (van Home Assistant)"},rt={missing_config:"Configuratie ontbreekt. Configureer de kaart.",missing_speakers:"Geen speakers geconfigureerd. Voeg speakers toe.",load_failed:"Kan afspeellijsten niet laden. Controleer de Music Assistant configuratie.",play_failed:"Kan afspeellijst niet afspelen"},ot={tabs:it,common:at,config:st,error:rt},nt={now_playing:"Сейчас играет",playlists:"Плейлисты",search:"Поиск",speakers:"Колонки"},lt={loading:"Загрузка...",error:"Произошла ошибка",no_playlists:"Плейлисты не найдены",play:"Воспроизвести",select_speaker:"Выбрать колонку",no_speaker_selected:"Колонка не выбрана",nothing_playing:"Сейчас ничего не воспроизводится",search:"Поиск",search_playlists:"Поиск плейлистов...",search_placeholder:"Поиск песен, альбомов, исполнителей...",search_hint:"Поиск музыки для воспроизведения",browse_library:"Просмотр вашей музыкальной библиотеки",end_of_list:"Конец списка",tracks:"Треки",albums:"Альбомы",artists:"Исполнители",favorites:"Избранное",add_favorite:"Добавить в избранное",remove_favorite:"Удалить из избранного",all:"Все",sort:"Сортировка",sort_name:"Имя (А-Я)",sort_name_desc:"Имя (Я-А)",sort_tracks:"Количество треков",sort_recent:"Недавно добавленные",view_grid:"Сетка",view_list:"Список",no_results:"Результаты не найдены",play_all:"Воспроизвести все",back:"Назад",no_tracks:"Треки не найдены"},ct={title:"Заголовок карточки",config_entry_id:"Экземпляр Music Assistant",speakers:"Колонки",limit:"Количество плейлистов",card_height:"Высота карточки (px)",card_height_helper:"Меньше высота = меньше обложка",columns:"Столбцы",columns_auto:"Авто",favorites_only:"Только избранное",language:"Язык",language_auto:"Авто (из Home Assistant)"},dt={missing_config:"Отсутствует конфигурация. Настройте карточку.",missing_speakers:"Колонки не настроены. Добавьте колонки в настройках.",load_failed:"Не удалось загрузить плейлисты. Проверьте настройки Music Assistant.",play_failed:"Не удалось воспроизвести плейлист"},pt={tabs:nt,common:lt,config:ct,error:dt},ht={now_playing:"Teraz gra",playlists:"Playlisty",search:"Szukaj",speakers:"Głośniki"},ut={loading:"Ładowanie...",error:"Wystąpił błąd",no_playlists:"Nie znaleziono playlist",play:"Odtwórz",select_speaker:"Wybierz głośnik",no_speaker_selected:"Nie wybrano głośnika",nothing_playing:"Nic nie jest obecnie odtwarzane",search:"Szukaj",search_playlists:"Szukaj playlist...",search_placeholder:"Szukaj utworów, albumów, artystów...",search_hint:"Wyszukaj muzykę do odtworzenia",browse_library:"Przeglądaj swoją bibliotekę muzyki",end_of_list:"Koniec listy",tracks:"Utwory",albums:"Albumy",artists:"Artyści",favorites:"Ulubione",add_favorite:"Dodaj do ulubionych",remove_favorite:"Usuń z ulubionych",all:"Wszystkie",sort:"Sortuj",sort_name:"Nazwa (A-Z)",sort_name_desc:"Nazwa (Z-A)",sort_tracks:"Liczba utworów",sort_recent:"Ostatnio dodane",view_grid:"Widok siatki",view_list:"Widok listy",no_results:"Brak wyników",play_all:"Odtwórz wszystko",back:"Wstecz",no_tracks:"Nie znaleziono utworów"},gt={title:"Tytuł karty",config_entry_id:"Instancja Music Assistant",speakers:"Głośniki",limit:"Liczba playlist",card_height:"Wysokość karty (px)",card_height_helper:"Mniejsza wysokość = mniejsza okładka",columns:"Kolumny",columns_auto:"Auto",favorites_only:"Tylko ulubione",language:"Język",language_auto:"Auto (z Home Assistant)"},mt={missing_config:"Brak konfiguracji. Skonfiguruj kartę.",missing_speakers:"Nie skonfigurowano głośników. Dodaj głośniki.",load_failed:"Nie udało się załadować playlist. Sprawdź konfigurację Music Assistant.",play_failed:"Nie udało się odtworzyć playlisty"},_t={tabs:ht,common:ut,config:gt,error:mt},yt={now_playing:"正在播放",playlists:"播放列表",search:"搜索",speakers:"扬声器"},ft={loading:"正在加载...",error:"发生错误",no_playlists:"未找到播放列表",play:"播放",select_speaker:"选择扬声器",no_speaker_selected:"未选择扬声器",nothing_playing:"当前没有播放内容",search:"搜索",search_playlists:"搜索播放列表...",search_placeholder:"搜索歌曲、专辑、艺术家...",search_hint:"搜索要播放的音乐",browse_library:"浏览你的音乐库",end_of_list:"列表结束",tracks:"歌曲",albums:"专辑",artists:"艺术家",favorites:"收藏",add_favorite:"添加到收藏",remove_favorite:"从收藏中移除",all:"全部",sort:"排序",sort_name:"名称 (A-Z)",sort_name_desc:"名称 (Z-A)",sort_tracks:"曲目数量",sort_recent:"最近添加",view_grid:"网格视图",view_list:"列表视图",no_results:"未找到结果",play_all:"全部播放",back:"返回",no_tracks:"未找到歌曲"},bt={title:"卡片标题",config_entry_id:"Music Assistant 实例",speakers:"扬声器",limit:"播放列表数量",card_height:"卡片高度 (px)",card_height_helper:"高度越小 = 封面越小",columns:"列数",columns_auto:"自动",favorites_only:"仅收藏",language:"语言",language_auto:"自动（从 Home Assistant）"},vt={missing_config:"缺少配置。请配置卡片。",missing_speakers:"未配置扬声器。请添加扬声器。",load_failed:"无法加载播放列表。请检查 Music Assistant 配置。",play_failed:"无法播放播放列表"},kt={tabs:yt,common:ft,config:bt,error:vt},xt={now_playing:"再生中",playlists:"プレイリスト",search:"検索",speakers:"スピーカー"},wt={loading:"読み込み中...",error:"エラーが発生しました",no_playlists:"プレイリストが見つかりません",play:"再生",select_speaker:"スピーカーを選択",no_speaker_selected:"スピーカーが選択されていません",nothing_playing:"現在再生中のものはありません",search:"検索",search_playlists:"プレイリストを検索...",search_placeholder:"曲、アルバム、アーティストを検索...",search_hint:"再生する音楽を検索",browse_library:"音楽ライブラリを閲覧",end_of_list:"リストの終わり",tracks:"曲",albums:"アルバム",artists:"アーティスト",favorites:"お気に入り",add_favorite:"お気に入りに追加",remove_favorite:"お気に入りから削除",all:"すべて",sort:"並び替え",sort_name:"名前 (A-Z)",sort_name_desc:"名前 (Z-A)",sort_tracks:"トラック数",sort_recent:"最近追加",view_grid:"グリッド表示",view_list:"リスト表示",no_results:"結果が見つかりません",play_all:"すべて再生",back:"戻る",no_tracks:"曲が見つかりません"},$t={title:"カードタイトル",config_entry_id:"Music Assistant インスタンス",speakers:"スピーカー",limit:"プレイリスト数",card_height:"カードの高さ (px)",card_height_helper:"高さを小さく = アートワークを小さく",columns:"列数",columns_auto:"自動",favorites_only:"お気に入りのみ",language:"言語",language_auto:"自動（Home Assistantから）"},St={missing_config:"設定がありません。カードを設定してください。",missing_speakers:"スピーカーが設定されていません。スピーカーを追加してください。",load_failed:"プレイリストの読み込みに失敗しました。Music Assistantの設定を確認してください。",play_failed:"プレイリストの再生に失敗しました"},At={tabs:xt,common:wt,config:$t,error:St};const zt={en:Object.freeze({__proto__:null,common:ye,config:fe,default:ve,error:be,tabs:_e}),he:Object.freeze({__proto__:null,common:xe,config:we,default:Se,error:$e,tabs:ke}),ar:Object.freeze({__proto__:null,common:ze,config:Pe,default:Te,error:Me,tabs:Ae}),de:Object.freeze({__proto__:null,common:Ne,config:Ee,default:Oe,error:je,tabs:Ce}),fr:Object.freeze({__proto__:null,common:Le,config:Ie,default:Fe,error:He,tabs:Re}),es:Object.freeze({__proto__:null,common:De,config:Ve,default:We,error:Ke,tabs:Ue}),it:Object.freeze({__proto__:null,common:Ze,config:qe,default:Ge,error:Qe,tabs:Be}),pt:Object.freeze({__proto__:null,common:Ye,config:Xe,default:tt,error:et,tabs:Je}),nl:Object.freeze({__proto__:null,common:at,config:st,default:ot,error:rt,tabs:it}),ru:Object.freeze({__proto__:null,common:lt,config:ct,default:pt,error:dt,tabs:nt}),pl:Object.freeze({__proto__:null,common:ut,config:gt,default:_t,error:mt,tabs:ht}),zh:Object.freeze({__proto__:null,common:ft,config:bt,default:kt,error:vt,tabs:yt}),ja:Object.freeze({__proto__:null,common:wt,config:$t,default:At,error:St,tabs:xt})},Pt=["he","ar"],Mt="en";let Tt=Mt;function Ct(e){const t=e.split("-")[0].toLowerCase();Tt=zt[t]?t:Mt}function Nt(){return Pt.includes(Tt)}function Et(e,t){const i=t.split(".");let a=e;for(const e of i){if(!a||"object"!=typeof a||!(e in a))return;a=a[e]}return"string"==typeof a?a:void 0}function jt(e,t){let i=Et(zt[Tt],e);return i||Tt===Mt||(i=Et(zt[Mt],e)),i||(console.warn(`[music-assistant-playlist-card] Missing translation for key: ${e}`),e)}const Ot=[{id:"now-playing",icon:"mdi:music-note",labelKey:"tabs.now_playing"},{id:"playlists",icon:"mdi:playlist-music",labelKey:"tabs.playlists"},{id:"search",icon:"mdi:magnify",labelKey:"tabs.search"},{id:"speakers",icon:"mdi:speaker",labelKey:"tabs.speakers"}];let Rt=class extends ne{constructor(){super(...arguments),this._selectedNewSpeaker="",this._massInstances=[],this._loadingInstances=!1}setConfig(e){if(this._config=e,this.hass){const t=e.language;Ct(t&&"auto"!==t?t:this.hass.language)}}updated(e){super.updated(e),e.has("hass")&&this.hass&&0===this._massInstances.length&&this._loadMusicAssistantInstances()}async _loadMusicAssistantInstances(){if(this.hass&&!this._loadingInstances){this._loadingInstances=!0;try{const e=await this.hass.callWS({type:"config_entries/get"});this._massInstances=e.filter(e=>"music_assistant"===e.domain&&"loaded"===e.state).map(e=>({entry_id:e.entry_id,title:e.title||"Music Assistant"})),console.info("[music-assistant-playlist-card] Found MA instances:",this._massInstances)}catch(e){console.error("[music-assistant-playlist-card] Failed to load MA instances:",e),this._massInstances=[]}finally{this._loadingInstances=!1}}}_configChanged(e){((e,t,i)=>{const a=new CustomEvent(t,{bubbles:!0,cancelable:!1,composed:!0,detail:i});e.dispatchEvent(a)})(this,"config-changed",{config:e})}_valueChanged(e){const t=e.target,i=t.dataset.configKey;if(!i)return;let a=t.value;"number"===t.type&&(a=parseInt(t.value,10),isNaN(a))||("checkbox"===t.type&&(a=t.checked),this._config={...this._config,[i]:a},this._configChanged(this._config))}_instanceChanged(e){const t=e.target;this._config={...this._config,config_entry_id:t.value},this._configChanged(this._config)}_columnsChanged(e){const t=e.target.value;this._config={...this._config,columns:"auto"===t?"auto":parseInt(t,10)},this._configChanged(this._config)}_removeSpeaker(e){this._config={...this._config,speakers:(this._config.speakers||[]).filter(t=>t!==e)},this._configChanged(this._config)}_speakerPickerChanged(e){e.stopPropagation();const t=e.detail?.value;console.log("[editor] Speaker picker changed:",t),this._selectedNewSpeaker=t||""}_addSelectedSpeaker(){if(!this._selectedNewSpeaker)return;if(this._config.speakers?.includes(this._selectedNewSpeaker))return console.log("[editor] Speaker already exists:",this._selectedNewSpeaker),void(this._selectedNewSpeaker="");const e=[...this._config.speakers||[],this._selectedNewSpeaker];this._config={...this._config,speakers:e},this._configChanged(this._config),console.log("[editor] Added speaker:",this._selectedNewSpeaker,"Total:",e.length),this._selectedNewSpeaker=""}_getEntityName(e){if(!this.hass)return e;const t=this.hass.states[e];return t?.attributes?.friendly_name||e}render(){if(!this.hass||!this._config)return V``;const e=Object.keys(zt);return V`
      <div class="editor-container">
        ...
        <div class="form-row">
          ...
          ${this._massInstances.length>0?V`
                <ha-select
        ...
        <div class="form-row">
          <label class="form-label">${jt("config.card_height")}</label>
          <ha-textfield
            type="number"
            ...
            min="400"
            max="1000"
            helper="${jt("config.card_height_helper")}"
          ></ha-textfield>
        </div>
    ...
    `}_formatTime(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,"0")}`}_renderNowPlaying(){const e=this._getMediaPlayerState();if(!this._selectedSpeaker)return V`
      ...
      `;const t="playing"===e?.state,i=e?.media_title,a=e?.media_duration&&e?.media_position?e.media_position/e.media_duration*100:0;return V`
      <div class="now-playing">
        <div class="now-playing-artwork">
          ${i&&e?.entity_picture?V`<img src="${e.entity_picture}" alt="Album art" />`:V`
    ...
    `}_renderSpeakers(){return V`
      <div class="speakers-grid">
        ${this._config.speakers.map(e=>{const t=this.hass?.states[e],i=e===this._selectedSpeaker,a=t?.state||"unavailable";return V`
            <button
    ...
    `}_handleGlobalSearchInput(e){const t=e.target;this._globalSearchQuery=t.value,this._debouncedSearch()}_handleSearchSubmit(e){e.preventDefault(),this._searchDebounceTimer&&clearTimeout(this._searchDebounceTimer),this._globalSearchQuery.trim()&&this._performSearch()}_setSearchMediaType(e){const t=this._searchMediaType!==e;this._searchMediaType=e,t&&(this._globalSearchQuery.trim()?this._performSearch():this._loadLibrary(!0))}_clearSearch(){this._globalSearchQuery="",this._searchResults=[],this._loadLibrary(!0)}async _performSearch(){if(this.hass&&this._config?.config_entry_id&&this._globalSearchQuery.trim()){this._searchLoading=!0,this._searchResults=[];try{const e=await this.hass.callWS({type:"call_service",domain:"music_assistant",service:"search",service_data:{config_entry_id:this._config.config_entry_id,name:this._globalSearchQuery,media_type:[this._searchMediaType],library_only:!1,limit:25},return_response:!0});console.info("[music-assistant-playlist-card] Search response:",e);const t=e?.response;t&&("track"===this._searchMediaType&&t.tracks?this._searchResults=t.tracks:"album"===this._searchMediaType&&t.albums?this._searchResults=t.albums:"artist"===this._searchMediaType&&t.artists&&(this._searchResults=t.artists)),console.info("[music-assistant-playlist-card] Search results:",this._searchResults.length)}catch(e){console.error("[music-assistant-playlist-card] Search failed:",e),this._searchResults=[]}finally{this._searchLoading=!1}}}async _loadLibrary(e=!0){if(this.hass&&this._config?.config_entry_id&&(e&&(this._libraryItems=[],this._libraryOffset=0,this._libraryHasMore=!0),this._libraryHasMore&&!this._libraryLoading)){this._libraryLoading=!0;try{const t=await this.hass.callWS({type:"call_service",domain:"music_assistant",service:"get_library",service_data:{config_entry_id:this._config.config_entry_id,media_type:this._searchMediaType,limit:this._libraryLimit,offset:this._libraryOffset,order_by:"name"},return_response:!0});console.info("[music-assistant-playlist-card] Library response:",t);let i=[];const a=t?.response;if(a){const e=this._searchMediaType+"s";if(a[e])i=a[e];else if(a.items)i=a.items;else for(const e of Object.values(a))if(Array.isArray(e)&&e.length>0){i=e;break}}i=i.map(e=>({...e,media_type:e.media_type||this._searchMediaType})),this._libraryItems=e?i:[...this._libraryItems,...i],this._libraryHasMore=i.length>=this._libraryLimit,this._libraryOffset+=i.length,console.info("[music-assistant-playlist-card] Library items loaded:",this._libraryItems.length,"hasMore:",this._libraryHasMore)}catch(e){console.error("[music-assistant-playlist-card] Failed to load library:",e),this._libraryHasMore=!1}finally{this._libraryLoading=!1}}}async _loadMoreLibrary(){!this._libraryLoading&&this._libraryHasMore&&await this._loadLibrary(!1)}_handleSearchScroll(e){const t=e.target;if(!t)return;const i=t.scrollTop;t.scrollHeight-i-t.clientHeight<100&&(this._globalSearchQuery.trim()||this._loadMoreLibrary())}_debouncedSearch(){this._searchDebounceTimer&&clearTimeout(this._searchDebounceTimer),this._searchDebounceTimer=setTimeout(()=>{this._globalSearchQuery.trim()?this._performSearch():(this._searchResults=[],this._loadLibrary(!0))},300)}async _playSearchResult(e){if(this.hass&&this._selectedSpeaker)try{const t=e.uri||e.item_id;await this.hass.callService("music_assistant","play_media",{media_id:t,media_type:e.media_type,enqueue:"replace"},{entity_id:this._selectedSpeaker}),console.info("[music-assistant-playlist-card] Playing:",e.name)}catch(e){console.error("[music-assistant-playlist-card] Failed to play:",e)}else console.warn("[music-assistant-playlist-card] No speaker selected")}async _toggleFavorite(e,t){if(t.stopPropagation(),t.preventDefault(),!this.hass||!this._config?.config_entry_id)return void console.warn("[music-assistant-playlist-card] Cannot toggle favorite: missing hass or config");const i=!0===e.favorite,a=!i,s=e.media_type||this._searchMediaType,r=e.uri||`library://${s}/${e.item_id}`;console.info("[music-assistant-playlist-card] Toggling favorite:",{name:e.name,item_id:e.item_id,uri:r,media_type:s,current:i,new:a}),e.favorite=a,this._searchResults=[...this._searchResults],this._libraryItems=[...this._libraryItems];const o=[async()=>{await this.hass.callService("music_assistant",a?"library_add":"library_remove",{config_entry_id:this._config.config_entry_id,uri:r})},async()=>{await this.hass.callService("music_assistant",a?"library_add":"library_remove",{config_entry_id:this._config.config_entry_id,media_id:r})},async()=>{await this.hass.callService("music_assistant",a?"library_add":"library_remove",{config_entry_id:this._config.config_entry_id,media_type:s,item_id:e.item_id})},async()=>{await this.hass.callWS({type:"call_service",domain:"music_assistant",service:a?"library_add":"library_remove",service_data:{config_entry_id:this._config.config_entry_id,uri:[r]}})}];for(let t=0;t<o.length;t++)try{return await o[t](),void console.info(`[music-assistant-playlist-card] Favorite toggled successfully (approach ${t+1}):`,e.name,"->",a)}catch(e){console.warn(`[music-assistant-playlist-card] Approach ${t+1} failed:`,e)}console.error("[music-assistant-playlist-card] All favorite toggle approaches failed"),e.favorite=i,this._searchResults=[...this._searchResults],this._libraryItems=[...this._libraryItems]}_getSearchResultImage(e){return e.image?"string"==typeof e.image?e.image:"object"==typeof e.image&&e.image.path?e.image.path:null:null}_getSearchResultArtist(e){return e.artist?e.artist:e.artists&&e.artists.length>0?e.artists.map(e=>e.name).join(", "):null}_renderSearch(){const e=this._globalSearchQuery.trim().length>0,t=!e,i=e?this._searchResults:this._libraryItems,a=e?this._searchLoading:this._libraryLoading;return V`
      <div class="search-view">
        ...
        ${t&&!a&&0===i.length&&this._libraryHasMore?V`
        ...
        `:i.length>0?V`
          <div class="search-results" @scroll=${this._handleSearchScroll}>
            ${i.map(e=>{const t=this._getSearchResultImage(e),i=this._getSearchResultArtist(e),a=e.media_type||this._searchMediaType,s=!0===e.favorite;return V`
                <div 
                  class="search-result-item"
                  @click=${()=>this._playSearchResult(e)}
                >
                  <div class="search-result-image ${"artist"===a?"artist-image":""}">
                    ${t?V`<img src="${t}" alt="${e.name}" />`:V`<ha-icon icon="${"artist"===a?"mdi:account-music":"album"===a?"mdi:album":"mdi:music-note"}"></ha-icon>`}
                  </div>
                  <div class="search-result-info">
                    <div class="search-result-title">${e.name}</div>
                    ${i?V`<div class="search-result-artist">${i}</div>`:W}
                    ${e.album?.name?V`<div class="search-result-album">${e.album.name}</div>`:W}
                  </div>
                  <button 
                    class="search-result-favorite ${s?"active":""}" 
                    title="${jt(s?"common.remove_favorite":"common.add_favorite")}"
                    @click=${t=>this._toggleFavorite(e,t)}
                  >
              ...
              `})}
            ${t&&this._libraryLoading?V`
              <div class="load-more-indicator">
                <div class="loading-spinner small"></div>
              </div>
            `:W}
            ${t&&!this._libraryHasMore&&i.length>0?V`
              <div class="end-of-list">
                <span>${jt("common.end_of_list")}</span>
              </div>
            `:W}
          </div>
        `:e&&!a?V`
        ...
        `:a?W:V`
          <div class="search-empty">
            ...
            <span>${jt("common.browse_library")}</span>
          </div>
        `}
      </div>
    `}_renderTabContent(){switch(this._activeTab){case"now-playing":return this._renderNowPlaying();case"playlists":return this._loading?this._renderLoading():this._error?this._renderError():this._renderPlaylistsView();case"search":return this._renderSearch();case"speakers":return this._renderSpeakers();default:return V``}}_renderPlaylistsView(){if(this._selectedPlaylist)return this._renderPlaylistDetail();const e=this._getFilteredPlaylists();return V`
    ...
    `}_renderPlaylistDetail(){if(!this._selectedPlaylist)return V``;const e=this._selectedPlaylist,t=this._getPlaylistImage(e);return V`
      <div class="playlist-detail">
        <div class="playlist-detail-header">
          ...
          <div class="playlist-detail-image">
            ${t?V`<img src="${t}" alt="${e.name}" />`:V`<ha-icon icon="mdi:playlist-music"></ha-icon>`}
          </div>
        ...
        ${this._loadingTracks?this._renderLoading():0===this._playlistTracks.length?V`
                <div class="empty-container">
    ...
    `}_renderTrackItem(e,t){const i=this._getTrackImage(e),a=this._getTrackArtist(e),s=this._formatDuration(e.duration);return V`
      <div 
        class="track-item"
      ...
      >
        ...
        <div class="track-info">
          ...
          ${a?V`<span class="track-artist">${a}</span>`:W}
        </div>
        ${s?V`<span class="track-duration">${s}</span>`:W}
        <button 
    ...
    `}_renderPlaylistItem(e){const t=this._getPlaylistImage(e);return V`
      ...
      >
        ...
        <div class="playlist-info">
          ...
          ${e.track_count?V`<p class="playlist-meta">${e.track_count} ${jt("common.tracks")}</p>`:W}
        </div>
        <button 
    ...
    `}_isPreviewMode(){return!this.hass||!this._config?.config_entry_id||""===this._config.config_entry_id}_renderPreview(){return V`
      <div class="now-playing">
    ...
    `}render(){if(!this._config)return V`
      ...
      `;const e=this._isConfigValid(),t=this._isPreviewMode()&&!e,i=this._config.card_height||680,a=Math.min(280,Math.max(120,.4*i));return V`
      <ha-card style="--card-height: ${i}px; --artwork-size: ${a}px;">
        ...
        <div class="tab-content">
          ${t?V`<div class="tab-view">${this._renderPreview()}</div>`:e?V`<div class="tab-view">${this._renderTabContent()}</div>`:V`<div class="tab-view">${this._renderConfigWarning()}</div>`}
        </div>
        ${this._renderTabBar()}
      </ha-card>
    `}};Lt.styles=ge,e([he({attribute:!1})],Lt.prototype,"hass",void 0),e([ue()],Lt.prototype,"_config",void 0),e([ue()],Lt.prototype,"_playlists",void 0),e([ue()],Lt.prototype,"_loading",void 0),e([ue()],Lt.prototype,"_error",void 0),e([ue()],Lt.prototype,"_selectedSpeaker",void 0),e([ue()],Lt.prototype,"_activeTab",void 0),e([ue()],Lt.prototype,"_currentLanguage",void 0),e([ue()],Lt.prototype,"_searchQuery",void 0),e([ue()],Lt.prototype,"_showFavoritesOnly",void 0),e([ue()],Lt.prototype,"_sortOption",void 0),e([ue()],Lt.prototype,"_viewMode",void 0),e([ue()],Lt.prototype,"_showSortMenu",void 0),e([ue()],Lt.prototype,"_globalSearchQuery",void 0),e([ue()],Lt.prototype,"_searchResults",void 0),e([ue()],Lt.prototype,"_searchLoading",void 0),e([ue()],Lt.prototype,"_searchMediaType",void 0),e([ue()],Lt.prototype,"_libraryItems",void 0),e([ue()],Lt.prototype,"_libraryLoading",void 0),e([ue()],Lt.prototype,"_libraryOffset",void 0),e([ue()],Lt.prototype,"_libraryHasMore",void 0),e([ue()],Lt.prototype,"_selectedPlaylist",void 0),e([ue()],Lt.prototype,"_playlistTracks",void 0),e([ue()],Lt.prototype,"_loadingTracks",void 0),Lt=e([ce("music-assistant-playlist-card")],Lt),window.customCards=window.customCards||[],window.customCards.push({type:"music-assistant-playlist-card",name:"Music Assistant Playlist Card",description:"Display Music Assistant playlists with speaker selection",preview:!0,documentationURL:"https://github.com/davidss20/music-assistant-playlist-card"});export{Lt as MusicAssistantPlaylistCard};
