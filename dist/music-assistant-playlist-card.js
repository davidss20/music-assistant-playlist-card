      ...
      <div class="search-view">
        ...
        `:i.length>0?V`
          <div class="search-results" @scroll=${this._handleSearchScroll}>
            ${i.map(e=>{const t=this._getSearchResultImage(e),i=this._getSearchResultArtist(e),a=e.media_type||this._searchMediaType;return e.favorite,V`
                <div 
