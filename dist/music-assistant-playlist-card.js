      ...
      <div class="search-view">
        ...
        `:this._searchResults.length>0?B`
          <div class="search-results">
            ${this._searchResults.map(e=>{const t=this._getSearchResultImage(e),i=this._getSearchResultArtist(e);return B`
                <div 
                ...
                >
                  ...
                  <div class="search-result-info">
                    ...
                    ${i?B`<div class="search-result-artist">${i}</div>`:W}
                    ${e.album?.name?B`<div class="search-result-album">${e.album.name}</div>`:W}
                  </div>
    ...
    `}_renderPlaylistItem(e){const t=this._getPlaylistImage(e);return B`
      ...
      >
        ...
        <div class="playlist-info">
          ...
          ${e.track_count?B`<p class="playlist-meta">${e.track_count} ${bt("common.tracks")}</p>`:W}
        </div>
      </div>
