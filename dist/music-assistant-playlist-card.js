    ...
    `}_renderPlaylistItem(e){const t=this._getPlaylistImage(e);return D`
      ...
      >
        ...
        <div class="playlist-info">
          ...
          ${e.track_count?D`<p class="playlist-meta">${e.track_count} ${bt("common.tracks")}</p>`:W}
        </div>
      </div>
