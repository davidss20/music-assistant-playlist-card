...
`;var fe={loading:"Loading playlists...",error:"An error occurred",no_playlists:"No playlists found",play:"Play",select_speaker:"Select Speaker",no_speaker_selected:"No speaker selected",nothing_playing:"Nothing is currently playing",queue_empty:"Queue is empty"},ye={title:"Card Title",config_entry_id:"Music Assistant Instance",speakers:"Speakers",limit:"Number of Playlists",columns:"Columns",columns_auto:"Auto",favorites_only:"Favorites Only",language:"Language",language_auto:"Auto (from Home Assistant)"},_e={missing_config:"Missing configuration. Please configure the card.",missing_speakers:"No speakers configured. Please add speakers in card settings.",load_failed:"Failed to load playlists. Please check your Music Assistant configuration.",play_failed:"Failed to play playlist"},ve={common:fe,config:ye,error:_e},be={loading:"טוען פלייליסטים...",error:"אירעה שגיאה",no_playlists:"לא נמצאו פלייליסטים",play:"הפעל",select_speaker:"בחר רמקול",no_speaker_selected:"לא נבחר רמקול",nothing_playing:"אין כרגע מוזיקה מתנגנת",queue_empty:"התור ריק"},xe={title:"כותרת הכרטיס",config_entry_id:"מופע Music Assistant",speakers:"רמקולים",limit:"מספר פלייליסטים",columns:"עמודות",columns_auto:"אוטומטי",favorites_only:"מועדפים בלבד",language:"שפה",language_auto:"אוטומטי (מ-Home Assistant)"},$e={missing_config:"חסרה הגדרה. אנא הגדר את הכרטיס.",missing_speakers:"לא הוגדרו רמקולים. אנא הוסף רמקולים בהגדרות הכרטיס.",load_failed:"נכשל בטעינת פלייליסטים. אנא בדוק את הגדרות Music Assistant.",play_failed:"נכשל בהפעלת הפלייליסט"},ke={common:be,config:xe,error:$e},we={loading:"Wiedergabelisten werden geladen...",error:"Ein Fehler ist aufgetreten",no_playlists:"Keine Wiedergabelisten gefunden",play:"Abspielen",select_speaker:"Lautsprecher auswählen",no_speaker_selected:"Kein Lautsprecher ausgewählt",nothing_playing:"Es wird derzeit nichts abgespielt",queue_empty:"Warteschlange ist leer"},Se={title:"Kartentitel",config_entry_id:"Music Assistant Instanz",speakers:"Lautsprecher",limit:"Anzahl der Wiedergabelisten",columns:"Spalten",columns_auto:"Automatisch",favorites_only:"Nur Favoriten",language:"Sprache",language_auto:"Automatisch (von Home Assistant)"},Ae={missing_config:"Konfiguration fehlt. Bitte konfigurieren Sie die Karte.",missing_speakers:"Keine Lautsprecher konfiguriert. Bitte fügen Sie Lautsprecher hinzu.",load_failed:"Wiedergabelisten konnten nicht geladen werden. Überprüfen Sie die Music Assistant Konfiguration.",play_failed:"Wiedergabeliste konnte nicht abgespielt werden"},Ce={common:we,config:Se,error:Ae},Ee={loading:"Chargement des playlists...",error:"Une erreur s'est produite",no_playlists:"Aucune playlist trouvée",play:"Lecture",select_speaker:"Sélectionner un haut-parleur",no_speaker_selected:"Aucun haut-parleur sélectionné",nothing_playing:"Rien n'est en cours de lecture",queue_empty:"La file d'attente est vide"},Pe={title:"Titre de la carte",config_entry_id:"Instance Music Assistant",speakers:"Haut-parleurs",limit:"Nombre de playlists",columns:"Colonnes",columns_auto:"Automatique",favorites_only:"Favoris uniquement",language:"Langue",language_auto:"Automatique (depuis Home Assistant)"},ze={missing_config:"Configuration manquante. Veuillez configurer la carte.",missing_speakers:"Aucun haut-parleur configuré. Veuillez ajouter des haut-parleurs.",load_failed:"Échec du chargement des playlists. Vérifiez la configuration de Music Assistant.",play_failed:"Échec de la lecture de la playlist"},Ne={common:Ee,config:Pe,error:ze},qe={loading:"Cargando listas de reproducción...",error:"Se produjo un error",no_playlists:"No se encontraron listas de reproducción",play:"Reproducir",select_speaker:"Seleccionar altavoz",no_speaker_selected:"Ningún altavoz seleccionado",nothing_playing:"No se está reproduciendo nada",queue_empty:"La cola está vacía"},Me={title:"Título de la tarjeta",config_entry_id:"Instancia de Music Assistant",speakers:"Altavoces",limit:"Número de listas de reproducción",columns:"Columnas",columns_auto:"Automático",favorites_only:"Solo favoritos",language:"Idioma",language_auto:"Automático (desde Home Assistant)"},Te={missing_config:"Falta la configuración. Por favor, configure la tarjeta.",missing_speakers:"No hay altavoces configurados. Por favor, agregue altavoces.",load_failed:"Error al cargar las listas de reproducción. Verifique la configuración de Music Assistant.",play_failed:"Error al reproducir la lista de reproducción"},je={common:qe,config:Me,error:Te};const Oe={en:Object.freeze({__proto__:null,common:fe,config:ye,default:ve,error:_e}),he:Object.freeze({__proto__:null,common:be,config:xe,default:ke,error:$e}),de:Object.freeze({__proto__:null,common:we,config:Se,default:Ce,error:Ae}),fr:Object.freeze({__proto__:null,common:Ee,config:Pe,default:Ne,error:ze}),es:Object.freeze({__proto__:null,common:qe,config:Me,default:je,error:Te})},Ie="en";let Ue=Ie;function Re(e){const t=e.split("-")[0].toLowerCase();Ue=Oe[t]?t:Ie}function He(e,t){const i=t.split(".");let s=e;for(const e of i){if(!s||"object"!=typeof s||!(e in s))return;s=s[e]}return"string"==typeof s?s:void 0}function Le(e,t){let i=He(Oe[Ue],e);return i||Ue===Ie||(i=He(Oe[Ie],e)),i||(console.warn(`[music-assistant-playlist-card] Missing translation for key: ${e}`),e)}const De=[{id:"now-playing",icon:"mdi:music-note",label:"Now Playing"},{id:"playlists",icon:"mdi:playlist-music",label:"Playlists"},{id:"queue",icon:"mdi:playlist-play",label:"Queue"},{id:"speakers",icon:"mdi:speaker",label:"Speakers"}];let Be=class extends ne{constructor(){super(...arguments),this._selectedNewSpeaker=""}setConfig(e){if(this._config=e,this.hass){const t=e.language;Re(t&&"auto"!==t?t:this.hass.language)}}_configChanged(e){((e,t,i)=>{const s=new CustomEvent(t,{bubbles:!0,cancelable:!1,composed:!0,detail:i});e.dispatchEvent(s)})(this,"config-changed",{config:e})}_valueChanged(e){const t=e.target,i=t.dataset.configKey;if(!i)return;let s=t.value;"number"===t.type&&(s=parseInt(t.value,10),isNaN(s))||("checkbox"===t.type&&(s=t.checked),this._config={...this._config,[i]:s},this._configChanged(this._config))}_columnsChanged(e){const t=e.target.value;this._config={...this._config,columns:"auto"===t?"auto":parseInt(t,10)},this._configChanged(this._config)}_addSpeaker(){this._selectedNewSpeaker&&(this._config.speakers?.includes(this._selectedNewSpeaker)?this._selectedNewSpeaker="":(this._config={...this._config,speakers:[...this._config.speakers||[],this._selectedNewSpeaker]},this._selectedNewSpeaker="",this._configChanged(this._config)))}_removeSpeaker(e){this._config={...this._config,speakers:(this._config.speakers||[]).filter(t=>t!==e)},this._configChanged(this._config)}_newSpeakerChanged(e){this._selectedNewSpeaker=e.detail.value||""}_getEntityName(e){if(!this.hass)return e;const t=this.hass.states[e];return t?.attributes?.friendly_name||e}render(){if(!this.hass||!this._config)return B``;const e=Object.keys(Oe);return B`
      <div class="editor-container">
        <!-- Basic Settings -->
        <div class="section-title">Basic Settings</div>

        <div class="form-row">
          <label class="form-label">${Le("config.title")}</label>
          <ha-textfield
        ...
        <div class="form-row">
          <label class="form-label">${Le("config.config_entry_id")}</label>
          <ha-textfield
        ...
        <!-- Speakers -->
        <div class="section-title">${Le("config.speakers")}</div>
        ...
        <div class="form-row">
          <label class="form-label">${Le("config.limit")}</label>
          <ha-textfield
            type="number"
        ...
        <div class="form-row">
          <label class="form-label">${Le("config.columns")}</label>
          <ha-select
            .value=${String(this._config.columns||"auto")}
            @selected=${this._columnsChanged}
            @closed=${e=>e.stopPropagation()}
          >
            <mwc-list-item value="auto">${Le("config.columns_auto")}</mwc-list-item>
        ...
        <div class="form-row">
          <ha-formfield .label=${Le("config.favorites_only")}>
            <ha-checkbox
        ...
        <!-- Language Settings -->
        <div class="section-title">${Le("config.language")}</div>
        ...
        <div class="form-row">
          <ha-select
            ...
            @closed=${e=>e.stopPropagation()}
          >
            <mwc-list-item value="auto">${Le("config.language_auto")}</mwc-list-item>
            ${e.map(e=>B`
    ...
    `}_renderEmpty(){return B`
      <div class="empty-container">
        ...
        <span class="empty-message">${Le("common.no_playlists")}</span>
      </div>
    ...
    `}_formatTime(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,"0")}`}_renderNowPlaying(){const e=this._getMediaPlayerState();if(!e||!this._selectedSpeaker)return B`
        <div class="now-playing">
          <div class="now-playing-idle">
            ...
            <span class="now-playing-idle-text">${Le("common.no_speaker_selected")}</span>
          </div>
        </div>
      `;const t="playing"===e.state;if("idle"===e.state||"off"===e.state||!e.media_title)return B`
        <div class="now-playing">
          <div class="now-playing-idle">
            ...
            <span class="now-playing-idle-text">${Le("common.nothing_playing")}</span>
          </div>
        </div>
    ...
    `}_getQueueItemImage(e){return e.image?"string"==typeof e.image?e.image:"object"==typeof e.image&&e.image.path?e.image.path:null:null}async _playQueueItem(e){if(this.hass&&this._selectedSpeaker)try{await this.hass.callService("music_assistant","play_index",{index:e},{entity_id:this._selectedSpeaker})}catch(e){console.error("[music-assistant-playlist-card] Failed to play queue item:",e)}}_renderQueue(){return this._selectedSpeaker?this._queueLoading?B`
      ...
      `:0===this._queueItems.length?B`
        <div class="queue-empty">
          ...
          <span>${Le("common.queue_empty")}</span>
        </div>
      `:B`
        ...
        ${this._queueItems.map((e,t)=>{const i=this._getQueueItemImage(e),s=t===this._currentQueueIndex;return B`
            ...
            >
              ...
              <div class="queue-item-info">
                ...
                ${e.artist?B`<div class="queue-item-artist">${e.artist}</div>`:W}
              </div>
              ${s?B`<ha-icon class="queue-item-playing-icon" icon="mdi:volume-high"></ha-icon>`:W}
            </div>
          `})}
      </div>
    `:B`
        <div class="queue-empty">
          <ha-icon icon="mdi:speaker-off"></ha-icon>
          <span>${Le("common.no_speaker_selected")}</span>
        </div>
      ...
      >
        <div class="playlist-image-container">
          ...
          <div class="play-overlay">
            <button class="play-button" aria-label="${Le("common.play")}">
        ...
        <div class="playlist-info">
          ...
          ${e.track_count?B`<p class="playlist-meta">${e.track_count} tracks</p>`:W}
        </div>
      </div>
    `}_isConfigValid(){return!!(this._config?.config_entry_id&&this._config?.speakers&&this._config.speakers.length>0)}_renderConfigWarning(){const e=!this._config?.config_entry_id,t=!this._config?.speakers||0===this._config.speakers.length;let i="";return e&&t?i=Le("error.missing_config"):t?i=Le("error.missing_speakers"):e&&(i="Please configure Music Assistant Instance ID"),B`
    ...
    `}render(){if(!this._config)return B`
        <ha-card>
          <div class="config-warning">
            <ha-icon icon="mdi:alert"></ha-icon>
            <span class="config-warning-message">${Le("error.missing_config")}</span>
          </div>
        </ha-card>
    ...
    `}};Ve.styles=ge,e([he({attribute:!1})],Ve.prototype,"hass",void 0),e([ue()],Ve.prototype,"_config",void 0),e([ue()],Ve.prototype,"_playlists",void 0),e([ue()],Ve.prototype,"_loading",void 0),e([ue()],Ve.prototype,"_error",void 0),e([ue()],Ve.prototype,"_selectedSpeaker",void 0),e([ue()],Ve.prototype,"_activeTab",void 0),e([ue()],Ve.prototype,"_queueItems",void 0),e([ue()],Ve.prototype,"_queueLoading",void 0),e([ue()],Ve.prototype,"_currentQueueIndex",void 0),Ve=e([ce("music-assistant-playlist-card")],Ve),window.customCards=window.customCards||[],window.customCards.push({type:"music-assistant-playlist-card",name:"Music Assistant Playlist Card",description:"Display Music Assistant playlists with speaker selection",preview:!0,documentationURL:"https://github.com/davidss20/music-assistant-playlist-card"});export{Ve as MusicAssistantPlaylistCard};
