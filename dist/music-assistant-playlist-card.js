    ...
    `:Q`
        <div class="queue-view">
          <div class="queue-empty-state">
            ...
            <span>${Nt("common.no_speaker_selected")}</span>
          </div>
        </div>
